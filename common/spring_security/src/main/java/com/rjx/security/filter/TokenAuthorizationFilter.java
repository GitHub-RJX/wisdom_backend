...
import com.rjx.security.entity.User;
...
public class TokenAuthorizationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public TokenAuthorizationFilter(AuthenticationManager authenticationManager, TokenManager tokenManager, RedisTemplate redisTemplate) {
